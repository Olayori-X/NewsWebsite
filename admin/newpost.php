                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <form id = "newsForm" method = "post" action = "insertarticle.php" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" id="existingcategory" readonly>
                                <input type ="hidden" name = "submitcategory" id = "submitcategory">
                            </div>

                            <div class="form-group">
                                <label for="reporter">Reporter</label>
                                <input class = "form-control" type = "text" id = "reporter" onclick= "toggleDiv('reporterDiv')" readonly required>
                                <input type ="hidden" name = "reporter" id = "submittedreporter">
